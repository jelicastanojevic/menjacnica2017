...
public class MenjacnicaGUI extends JFrame {
	...
	private void prikaziObrisiKursGUI() {
		if (table.getSelectedRow() != -1) {
			MenjacnicaTableModel model = (MenjacnicaTableModel) (table.getModel());
			GUIKontroler.prikaziObrisiKursProzor(model.vratiValutu(table.getSelectedRow()));
		}
	}
	...
	private void prikaziIzvrsiZamenuGUI() {
		if (table.getSelectedRow() != -1) {
			MenjacnicaTableModel model = (MenjacnicaTableModel) (table.getModel());
			GUIKontroler.prikaziIzvrsiZamenuProzor(model.vratiValutu(table.getSelectedRow()));
		}
	}
